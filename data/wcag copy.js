...
const sc_3_3_2 = new SuccessCriterion(
    ...
    {
        type: 'image',
        note: 'Example for SC 3.3.2',
        item:
            { id: 'pass', uri: require('../assets/examples/pass_3_3_1.png'), alt: 'Form labels are present', caption: 'Clear, associated labels', isPassing: true }
        ,
    },
    {
...
const sc_3_3_3 = new SuccessCriterion(
    ...
    'If an input error is automatically detected and suggestions for correction are known, they are provided to the user.',
    {
        ...
        items: [
            { id: 'pass', uri: require('../assets/examples/pass_3_3_3.png'), alt: 'Error message suggests valid format', caption: 'Actionable suggestions', isPassing: true },
            { id: 'fail', uri: require('../assets/examples/fail_3_3_3.png'), alt: 'Generic error without hint', caption: 'No correction guidance', isPassing: false },
        ],
    },
    {
...
const quiz_3_3 = new Quiz('3.3', [
    {
        id: 'q1',
        stem: 'A required field is left empty and the user submits the form. To meet 3.3.1 (Error Identification) you should…',
        options: [
            { id: 'a', label: 'Show a generic toast that something went wrong', isCorrect: false },
            { id: 'b', label: 'Highlight the field and describe the problem next to it', isCorrect: true },
            { id: 'c', label: 'Change the field border to red with no message', isCorrect: false },
        ],
    },
    {
        id: 'q2',
        stem: 'To meet 3.3.2 (Labels or Instructions), which is best for a phone number field?',
        options: [
            { id: 'a', label: 'Provide a clear label and example format (e.g., “Phone (e.g., +1 415 555 0000)”)', isCorrect: true },
            { id: 'b', label: 'Rely on placeholder text only', isCorrect: false },
            { id: 'c', label: 'Let the user guess the expected format', isCorrect: false },
        ],
    },
    {
        id: 'q3',
        stem: 'For 3.3.3 (Error Suggestion), the user types “name@gmal.com”. What satisfies the SC?',
        options: [
            { id: 'a', label: 'Silently autocorrect without telling the user', isCorrect: false },
            { id: 'b', label: 'Offer “Did you mean name@gmail.com?” with a one-tap fix', isCorrect: true },
            { id: 'c', label: 'Only say “Invalid email” with no guidance', isCorrect: false },
        ],
    },
    {
        id: 'q4',
        stem: 'Which pattern satisfies 3.3.4 (Error Prevention:Legal, Financial, Data) for a risky submission?',
        options: [
            { id: 'a', label: 'Show a review/confirm step before finalizing the action', isCorrect: true },
            { id: 'b', label: 'Submit immediately and show a success toast', isCorrect: false },
            { id: 'c', label: 'Allow undo only if the app stays open', isCorrect: false },
        ],
    },
    {
        id: 'q5',
        stem: 'What’s the best way to associate an error message with its field ?',
        options: [
            { id: 'a', label: 'Put all errors at the top of the page only', isCorrect: false },
            { id: 'b', label: 'Programmatically link the error text to the field and place it nearby', isCorrect: true },
            { id: 'c', label: 'Use color alone to indicate the error', isCorrect: false },
        ],
    },
    {
        id: 'q6',
        stem: 'Which approach best prevents input mistakes up front?',
        options: [
            { id: 'a', label: 'Hide labels to keep the UI clean', isCorrect: false },
            { id: 'b', label: 'Let users type anything and validate after submit only', isCorrect: false },
            { id: 'c', label: 'Use clear labels, format hints, and input constraints/masks', isCorrect: true },
